                            ...
                            if (isset($_POST['edit'])) {
                                ...
                                if (empty($formErrors)) {
                                        $stmt = $con->prepare("UPDATE lessons 
                                                                SET lesson_name = ?, lesson_description = ?, video = ?, member_id = ?, pdf = ?, Approve = ?
                                                                WHERE lesson_id  = ?");
                                        $stmt->execute(array($name, $description, $video , $_SESSION['ID'], $pdf, $approve, $lessonid ));
                                        if ($stmt) {
                                            echo '<div class="alert alert-success text-center alert-dismissible fade show" role="alert" id="alert-message">
							            ...
							            foreach($rows as $row) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button " class="btn btn-outline-success btn-sm lesson_edit main_view" value="<?php echo $row['lesson_id'];?>">تعديل</button>
                                                ...
                                                <select name="category" class="form-control">
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach ($allCats as $cat) {
                                                            echo "<option value='" . $cat['category_id'] . "' disabled>" . $cat['category_name'] . "</option>";
