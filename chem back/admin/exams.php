                    ...
                    <?php
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if (isset($_POST['add3'])) {
                                ...
                                if (empty($formErrors)) {
                                        $stmt = $con->prepare("INSERT INTO 
                                                    exams(exam_name, exam_desc, categ_id, type, exam_date, member_id )
                                                    VALUES(:exam_name, :exam_desc, :categ_id, 2, now(), :member_id)");
                                        $stmt->execute(array(
                                            'exam_name'  => $name,
                                            'exam_desc'  => $link,
                                            'categ_id'   => $category,
                            ...
                            if (isset($_POST['add2'])) {
                                ...
                                if (empty($formErrors)) {
                                        $stmt = $con->prepare("INSERT INTO 
                                                    exams(exam_name, exam_date, member_id, categ_id, number, type, time)
                                                    VALUES(:exam_name, now(), :member_id, :categ_id, :number, 2, :time)");
                                        $stmt->execute(array(
                                            'exam_name'  => $name,
                                            'member_id'  => $_SESSION['ID'],
                                            'categ_id'   => $category,
                                            ...
                                            foreach($rows as $row) {?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                            if ($row['categ_id'] == 1) {
                                                                echo ' الصف الاول الاعداى';
                                                            } elseif ($row['categ_id'] ==2) {
                                                                echo ' الصف الثانى الاعداى';
                                                            } elseif ($row['categ_id'] ==3) {
                                                                echo ' الصف الثالث الاعداى';
                                                            } elseif ($row['categ_id'] ==4) {
                                                                echo ' الصف الاول الثانوى';
                                                            } elseif ($row['categ_id'] ==5) {
                                                                echo ' الصف الثانى الثانوى';
                                                            } elseif ($row['categ_id'] ==6) {
                                                                echo ' الصف الثالث الثانوى';
                                                            }
                                                        ?>
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="lesson" class="form-control" >
                                                    <option disabled selected>...</option>
                                                    <?php
                                                        $childCats = getAllFrom("*", "category", "where parent != 0", "", "category_id", "asc");
                                                        foreach ($childCats as $child) {
                                                            echo "<option disabled>--- " . $child['category_name'] . "</option>";
                                                            $allMembers = getAllFrom("*", "lessons", "WHERE cat_id = {$child['category_id']}", "", "lesson_id");
