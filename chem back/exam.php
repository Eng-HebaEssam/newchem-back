    ...
    <section id="account" class="account mt-4">
        <div class="container">
          <div class="section-header mb-5">
              <h3 class="section-title"><?php echo $exam['exam_name']; ?></h3>
            </div>
        </div>
      </section>
                                        ...
                                        foreach ($exams as $exam ) {
                                            if(empty($exam['answer'])){ ?>
                                                <div class="question">
                                                    ...
                                                    ?>
                                                    <div class="q">
                                                        <input type="radio" id="chose1" name="<?php echo 'main'.$exam['id']; ?>" value="1" required>
                                                        <label for="chose1"><?php echo $exam['answer_1'];?></label>
                                                    </div>
                                                    <div class="q">
                                                        <input type="radio" id="chose2" name="<?php echo 'main'.$exam['id']; ?>" value="2" required>
                                                        <label for="chose2"><?php echo $exam['answer_2'];?></label>
                                                    </div>
                                                    <div class="q">
                                                        <input type="radio"  id="chose3" name="<?php echo 'main'.$exam['id']; ?>" value="3" required>
                                                        <label for="chose3"><?php echo $exam['answer_3'];?></label>
                                                    </div>
                                                    <div class="q">
                                                        <input type="radio"  id="chose4" name="<?php echo 'main'.$exam['id']; ?>" value="4" required>
