...
if (isset($_SESSION['user']) && $info['regstatus'] == 1) { 
    ...
    $getposts = $con->prepare("SELECT * FROM post where type = 0 AND cat_id = ? order by post_id desc");
...
<section id="account" class="account mt-4">
    ...
    <section id="section6" class="section6 mt-3">
        <div class="container">
                ...
                <?php foreach($activities as $activity) { ?>
                    <div class="main_item text-right">
                        ...
                        <div class="buttons mt-3 text-center">
                            <button class="main btn show_btn" data-show_item="show">التعليقات</button>
